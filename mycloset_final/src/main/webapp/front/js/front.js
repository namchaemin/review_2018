...
window.fbAsyncInit = function() {
	...
	FB.Event.subscribe('auth.logout', function(response) {
		location.href="http://www.mycloset.link:9899";		
	});
};
...
$("#emailBtn1").keyup(
		function() {
			...
			$.post("user/loginCheck", {
				...
				if (emailBtn == dbemail) {
					$("#add2Check").attr("style", "display:none");
					$("#addCheck").attr("style", "display:block").attr("style","color:#bd081c");
				}
			});
});
...
$("#pwdBtn2").keyup(
		function() {
			...
			pwdBtn2 = $("#pwdBtn2").val();
				...
				console.log();	
			if (pwdBtn1 != pwdBtn2) {
				$("#pwdcheck").attr("style", "display:block").attr("style","color:#bd081c");
			}
			if (pwdBtn1 == pwdBtn2) {
...
$('#fullpage').fullpage(
		{
			sectionsColor : [ '#99c5ab', '#56bc8a', '#a77dc2', '#36465d',
					'#f2992e' ],
